...
The software implementation was developed with the assistance of
AI-powered development tools integrated into Visual Studio Code.

AI assistance was used as a development tool under the direction,
review, testing and engineering supervision of the original author.

THIRD-PARTY SOURCES

This project may retrieve or reference information from third-party
cybersecurity sources and services.

Third-party names, trademarks, APIs, documentation and data remain
the property of their respective owners and are subject to their
respective licenses and terms of use.

LICENSE

The project source code is licensed under:

GNU General Public License v3.0 or later
(GPL-3.0-or-later)

See LICENSE for the complete license text.BELEROFONTE TOOL'S FIREFOX EXTENSION
